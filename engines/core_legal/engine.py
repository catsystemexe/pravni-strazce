    ...
    return {
        "issues": [
            {
                ...
                "text": (
                    "Je třeba přesně identifikovat, jaká právní otázka je v jádru vašeho dotazu. "
                    "V plné verzi zde bude konkrétní formulace problému na základě vstupu."
                ),
        ...
        "rules": [
            {
                ...
                "text": (
                    ...
                    "podle zjištěné právní domény (občanské, trestní, rodinné, ...)."
                ),
        ...
        "conclusion": {
            "summary": (
                ...
                "Plná verze zde nabídne konkrétnější odpověď a doporučený postup."
            ),
            "certainty": "REASONED_INFERENCE",
        },
        "meta": {
...
def run(engine_input: EngineInput) -> EngineOutput:
    """
    Hlavní entry point core_legal_engine.

    V téhle verzi:
    - jen bere case context a vrací baseline IRAC strukturu
    - nic nevolá ven (žádné databáze, žádné LLM)
    """
